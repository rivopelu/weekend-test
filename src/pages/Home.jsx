            ...
            <ContainerPage className={"flex items-center lg:h-[96vh] w-full justify-center "}>
                <div
                    ...
                    <SVG src={ASSETS.HOME_PINK_SVG}
                         className={"absolute opacity-0 lg:opacity-100 lg:right-[0] lg:translate-x-[200px] translate-y-24"}/>
                    <div className={"text-center relative z-[340]"}>
                        <h1 className={"lg:text-[62px] text-[52px] font-extrabold lg:tracking-widest"}>WEEKEND FROM
                            HOME</h1>
                        <span className={"text-[21px] italic font-bold"}>Stay active with a little workout.</span>
                    </div>
                    <div
                    ...
                    <div className={"flex flex-col items-center justify-center relative mt-[67px]"}>
